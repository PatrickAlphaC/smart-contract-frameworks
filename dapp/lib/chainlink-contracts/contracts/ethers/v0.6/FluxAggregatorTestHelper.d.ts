...
export class FluxAggregatorTestHelper extends Contract {
  ...
  functions: {
    ...
    requestedRoundId(): Promise<BigNumber>;
  };
  ...
  estimate: {
    ...
    readLatestRound(_aggregator: string): Promise<BigNumber>;

    readLatestRoundData(_aggregator: string): Promise<BigNumber>;
    ...
    requestNewRound(_aggregator: string): Promise<BigNumber>;
