...
export class FlagsInterface extends Contract {
  ...
  functions: {
    ...
    getFlags(arg0: string[]): Promise<boolean[]>;
  ...
  estimate: {
    lowerFlags(arg0: string[]): Promise<BigNumber>;

    getFlag(arg0: string): Promise<BigNumber>;

    setRaisingAccessController(arg0: string): Promise<BigNumber>;

    raiseFlags(arg0: string[]): Promise<BigNumber>;

    getFlags(arg0: string[]): Promise<BigNumber>;
